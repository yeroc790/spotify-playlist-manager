...
// takes a Spotify API tracks array, returns array of only track uris
...
//   // old code for when playlist/[tracks] was an object like {date_added: '', track: {}}
...
export const generateUriSet = (tracks) => {
  ...
  // from when tracks was a set
  // if (tracks.size == 0) return new Set()
  // return new Set([...tracks].map(track => { return track.uri }))
}
...
// simplifies album object to only properties needed for playlist
